...
//
//import command.util.ExcelUtil;
//import command.data.MemberData;
...
//    private static final String[] fileExtensions = new String[]{".png", ".jpg", ".gif"};
//    private PriorityQueue<Pair<Integer, Integer>> photoIDsPosted;
//    private Yaml yaml;
//    private ExcelUtil excelUtil;
//    private String currDate;
//    private StopWatch stopWatch;
//    private static final int NUMBER_NUG_PHOTOS = 18;
//
//    public DataUtil() {
...
//        photoIDsPosted = new PriorityQueue<>(
//                Comparator.comparing(a -> a.getValue()));
...
//                    photoIDsPosted.poll();
//                }
//                photoIDsPosted.offer(new Pair(rand, (int) stopWatch.getTime()));
