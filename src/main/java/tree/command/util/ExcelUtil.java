...
public class ExcelUtil {
    ...
    private static void writeMemberData(Row row, int colNum, MemberData memData) {
        Cell cell = row.createCell(colNum++);
        cell.setCellValue(memData.getNickName());
        cell = row.createCell(colNum++);
        cell.setCellValue(memData.getTimeStamp());
        cell = row.createCell(colNum);
        cell.setCellValue(memData.getContent());
    }

    public static void writeToExcel(Map<String, MemberData> uniqueUsersMap, File file,
