...
public class MessageUtil {
    ...
    // To be sent to MessageUtils.
    public static void sendError(String error, MessageChannel msgChan) {
    ...
    /**
     * Checks if the date after the "get" tree.command is a date. Correct format is: MM/DD/YYYY.
     * @param text
     * @return
     */
