 ...
 */
public class SetPermissionsVisitor implements GuildPermissionsVisitor {
    ...
    public void visit(Guild guild, TextChannelPerm textPerm, long id) throws SQLException {
        ...
        db.setGuildPermissions(guild, textChannel);
    }
